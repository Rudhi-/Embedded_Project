...
{   
    ...
    /* Select clock source */
    PLIB_TMR_ClockSourceSelect(TMR_ID_5, DRV_TMR_CLKSOURCE_INTERNAL);
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_5, 62500);
    /* Setup Interrupt */   
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_3, 12);
    /* Setup Interrupt */   
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_4, 12);
    /* Setup Interrupt */   
